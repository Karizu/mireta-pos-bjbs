...
public class RecyOldTransactionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
...
//                }
    ...
    public RecyOldTransactionAdapter(ListActionLoadMore mListener, boolean isPPOB) {
